...
# VGG16 for SVHN dataset (3-channel input, 10 classes)

# 重新实现 VGG16_SVHN，模仿 ResNet18_SVHN 写法
class VGG16_SVHN(nn.Module):
    def __init__(self, num_classes=10):
        super(VGG16_SVHN, self).__init__()
        vgg16 = models.vgg16(pretrained=False)
        self.features = vgg16.features
        self.fc = nn.Linear(512, num_classes)  # 只用 512
